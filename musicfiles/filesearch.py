...
# wildcard can be passed by adding anything close
# like aero* and anything that is close will be returned
# case sensitive of mac but not linux/windows
...
for s in song_list:
    print(s)
# fnmatch is a filter to find what you enter
